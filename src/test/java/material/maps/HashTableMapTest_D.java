...
public class HashTableMapTest_D {
	...
	public void testSize() {
		...
		listin.put("Jose", new Integer(912_127_659));
		listin.put("Angel", new Integer(912_127_658));
		listin.put("Abraham", new Integer(912_127_657));
		listin.put("Mayte", new Integer(912_127_656));
		listin.put("Raul", new Integer(912_127_655));
	...
	public void testIsEmpty() {
		...
		listin.put("Jose", new Integer(912_127_654));
	...
	public void testPutAndGet() {
		...
		try {
			listin.put(null, new Integer(1_213_123));
			fail("Deberia lanzar: InvalidKeyException");
		...
		listin.put("Jose", new Integer(912_127_654));
		listin.put("Jose", new Integer(912_127_651));
		listin.put("Andres", new Integer(912_127_624));
		assertEquals(listin.size(), 2);
		assertEquals(listin.get("Jose"), new Integer(912_127_651));
		assertEquals(listin.get("Andres"), new Integer(912_127_624));
	}
	...
	public void testValues() {
		Map<String, Integer> listin = new HashTableMapLP<>();
		listin.put("Angel", new Integer(912_127_654));
		listin.put("Jose", new Integer(912_127_651));
		listin.put("Andres", new Integer(912_127_624));
		...
		assertEquals(l.contains(new Integer(912_127_654)), true);
		assertEquals(l.contains(new Integer(912_127_651)), true);
		assertEquals(l.contains(new Integer(912_127_624)), true);
	}
