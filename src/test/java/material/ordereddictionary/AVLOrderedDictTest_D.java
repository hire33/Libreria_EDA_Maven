...
public class AVLOrderedDictTest_D {

	@Test
	public void testSize() {
		OrderedDictionary <String,Integer> dict = new AVLOrderedDictionary <>();
	...
	public void testInsert() {
		OrderedDictionary <Integer,Integer> dict = new AVLOrderedDictionary <>();
